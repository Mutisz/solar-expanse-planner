      ...
      <table className={tableClass}>
        <thead className="bg-gray-900">
          <tr>
            ...
            <th className={thClass}>Payload (t)</th>
            <th className={thClass}>Reusable</th>
            <th className={thClass}>Crew</th>
            <th className={thClass}>Max G</th>
            <th className={thClass}>Launch Cost</th>
            <th className={thClass}>Maint ($/mo)</th>
            <th className={thClass}>Workers</th>
            <th className={thClass}>Energy</th>
            <th className={thClass}>Launch Bonus</th>
            <th className={thClass}>Prereq</th>
        ...
        <tbody>
          {sorted.map((item) => (
            <tr key={item.name} className="hover:bg-gray-900/50">
              ...
              <td className={`${tdClass} text-right tabular-nums`}>{item.payload || '—'}</td>
              <td className={tdClass}>{item.reusable || '—'}</td>
              <td className={tdClass}>{item.crew || '—'}</td>
              <td className={tdClass}>{item.maxG || '—'}</td>
              <td className={tdClass}>{item.launchCost || '—'}</td>
              <td className={`${tdClass} text-right tabular-nums`}>{item.maintenance || '—'}</td>
              <td className={`${tdClass} text-right tabular-nums`}>{item.workers || '—'}</td>
              <td className={`${tdClass} text-right tabular-nums`}>{item.energy || '—'}</td>
              <td className={tdClass}>{item.launchBonus || '—'}</td>
              <td className={tdClass}>{item.prereq || '—'}</td>
